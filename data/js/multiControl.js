L.Control.multiControl = L.Control.extend({
    ...
    createStructure: function(){
        const container = L.DomUtil.create('div', 'leaflet_controllable_legend');
        const collapse_myIcon = L.DomUtil.create('div', 'fas collapse_my hidden');
        collapse_myIcon.addEventListener('click', () => this.toggle());

        const head = this.createHead();
        const body = this.createBody();

        container.append(collapse_myIcon);
    ...
    createBody: function(){
        const body = L.DomUtil.create('div', 'leaflet_controllable_legend-body');
    ...
    createHead() {
        const head = L.DomUtil.create('div', 'leaflet_controllable_legend-head');
    ...
    createChild(overlay, i){
        ...
        const elements = this.defineLayerElements(overlay.layer),
              div = L.DomUtil.create('div', 'child_container'),
              childOverlay_my = L.DomUtil.create('div', 'childOverlay_my'),
              ...
              inputsContainer_my = L.DomUtil.create('div', 'inputsContainer_my hidden')
        ...
        check.addEventListener('click', (e) => {
            ...
            inputsContainer_my.classList.toggle('hidden');
        ...
        childOverlay_my.addEventListener('click', e => check.click());
        ...
        childOverlay_my.append(left)
        childOverlay_my.append(right)


        div.append(childOverlay_my);

        const inputsContainer_myLeft = L.DomUtil.create('div', 'left');
        const inputsContainer_myRight = L.DomUtil.create('div', 'right');

        inputsContainer_my.append(inputsContainer_myLeft);
        inputsContainer_my.append(inputsContainer_myRight);
        div.append(inputsContainer_my);
        ...
        if(elements.opacity){
            ...
            inputsContainer_myLeft.append(range);
        }
        ...
        if(elements.color && elements.legend){
            ...
            if(overlay.layer.options.style){
                ...
                legend.append(legendContainer);
                inputsContainer_myLeft.prepend(color);
            }
        ...
        if(elements.bringToFront){
            ...
            inputsContainer_myRight.append(front);
        }
        ...
        if(elements.bringToBack){
            ...
            inputsContainer_myRight.append(back);
        }
    ...
    addOverlay(layer){
        ...
        const body = document.querySelector('.leaflet_controllable_legend-body');
